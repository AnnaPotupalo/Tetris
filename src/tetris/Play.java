...
public class Play extends JFrame implements KeyListener {
    ...
    public Play() {
        ...
        allRect = new int[]{0x00cc, 0x8888, 0x000f, 0x0c44, 0x002e, 0x088c, 0x00e8, 0x0c88, 0x00e2, 0x044c, 0x008e,
                0x08c4, 0x006c, 0x04c8, 0x00c6, 0x08c8, 0x004e, 0x04c4, 0x00e4}; // 19 видов квадратных форм, например,
        // 0x00cc равно 0000, что означает квадрат 2 * 2 0000 1100 1100
    ...
    public void init() {
        ...
        right.add(label);
        label1.setForeground(Color.RED); // Установить для содержимого метки красный шрифт
        right.add(label1);
